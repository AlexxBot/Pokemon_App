...
2. Then you need to setup a new user variable path with the path of your flutter/bin folder
...
7. Check if the flutter version is ***2.10.5***, if not run the commnad ***"flutter downgrade v2.10.5"***
